...
const PACKS = [
  {
    ...
    features: [
      ...
      { label: "Simple onboarding", enabled: false },
    ],
  },
  {
    plan: "Pro",
    ...
    features: [
      ...
      { label: "Advanced reporting", enabled: true },
      { label: "Priority onboarding", enabled: true },
    ],
  },
  {
    plan: "Enterprise",
...
export default function PackagesCoverflow() {
  ...
  return (
    <section className="relative z-10 py-16 px-4 sm:px-6 bg-gray-100 dark:bg-gray-900 overflow-hidden">
          ...
          {PACKS.map((_, i) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition ${
                i === index ? "bg-[#1B1664]" : "bg-gray-300 dark:bg-gray-600"
              }`}
            />
          ))}
        </div>
